...
class MissionAdmin extends Admin
{
    ...
    public function prePersist($mission)
    {
        $user = $this
            ...
            ->getUser()
        ;
        $mission->setPostedBy($user);

        $mission->preUpload();
    }

    public function preUpdate($mission)
    {
        $user = $this
            ->getConfigurationPool()
            ->getContainer()
    ...
    public function postPersist($mission)
    {
        $mission->upload();
    }

    public function postUpdate($mission)
    {
        $mission->upload();
    }
}
