...
class HomeAdmin extends Admin
{
    ...
    public function prePersist($home)
    {
        $user = $this
            ...
            ->getUser()
        ;
        $home->setPostedBy($user);

        $home->preUpload();
    }

    public function preUpdate($home)
    {
        $user = $this
            ->getConfigurationPool()
            ->getContainer()
    ...
    public function postPersist($home)
    {
        $home->upload();
    }
